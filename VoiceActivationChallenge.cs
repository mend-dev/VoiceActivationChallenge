...
using VoiceActivationChallenge;

[assembly: MelonInfo(typeof(VoiceActivationChallenge.VoiceActivationChallenge), ModHelperData.Name, ModHelperData.Version, ModHelperData.RepoOwner)]
[assembly: MelonGame("Ninja Kiwi", "BloonsTD6")]

namespace VoiceActivationChallenge;

public class VoiceActivationChallenge : BloonsTD6Mod {

    bool moneyFrozen = false;
    double moneyFreezed = 0d;

    public override void OnApplicationStart() {
        ModHelper.Msg<VoiceActivationChallenge>("VoiceActivationMod loaded!");
    }
        ...
        if (InGame.instance != null && InGame.instance.bridge != null) {
            ...
            if (Input.GetKeyDown(KeyCode.F1)) {
                ...
                for (int i = 0; i < tts.Count; i++) {
                    ...
                    tts[i].tower.PositionTower(new Il2CppAssets.Scripts.Simulation.SMath.Vector2(x, y));
                }
